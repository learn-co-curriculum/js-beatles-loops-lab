...
Typo on the test details: "describe('Beatles Loops' (SHOULDN'T THIS BE "theBeatlesPlay"??)  , function() {
  it("returns an array of strings containing WHICH INSTRUMENT each MUSICIAN plays", function() {
